...
class ProblemTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem_tag" do
    assert_difference("ProblemTag.count") do
      post problem_tags_url, params: { problem_tag: { problem_id: @problem_tag.problem_id, tag_id: @problem_tag.tag_id } }
    end
  ...
  test "should update problem_tag" do
    patch problem_tag_url(@problem_tag), params: { problem_tag: { problem_id: @problem_tag.problem_id, tag_id: @problem_tag.tag_id } }
